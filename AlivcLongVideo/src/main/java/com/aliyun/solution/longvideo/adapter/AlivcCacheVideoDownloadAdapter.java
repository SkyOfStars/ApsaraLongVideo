 ...
 * @author hanyu
 */
public class AlivcCacheVideoDownloadAdapter extends RecyclerView.Adapter<AlivcCacheVideoDownloadAdapter.DownloadHolder> {
    ...
    public void onBindViewHolder(@NonNull final DownloadHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onItemClick(AlivcCacheVideoDownloadAdapter.this, holder.itemView, holder.getAdapterPosition());
                }
            }
        });
        holder.ivPreView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mOnItemChildClickListener.onItemChildClick(AlivcCacheVideoDownloadAdapter.this, v, holder.getAdapterPosition());
            }
        });
    ...
    public interface OnItemClickListener {
         ...
         * been clicked.
         */
        void onItemClick(AlivcCacheVideoDownloadAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(AlivcCacheVideoDownloadAdapter adapter, View view, int position);
    }
}
