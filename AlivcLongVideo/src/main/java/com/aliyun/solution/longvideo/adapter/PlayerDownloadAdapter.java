 ...
 * @author hanyu
 */
public class PlayerDownloadAdapter extends RecyclerView.Adapter<PlayerDownloadAdapter.DownloadHolder> {
     ...
     * 是否是显示电视剧集时候（RESET状态）
     */
    private boolean mIsShowChildVideo = false;


    public PlayerDownloadAdapter(Context context) {
    ...
    public void setShowChildVideo(boolean showChildVideo) {
        mIsShowChildVideo = showChildVideo;
        notifyDataSetChanged();
    }
    ...
    public void onBindViewHolder(@NonNull final DownloadHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onItemClick(PlayerDownloadAdapter.this, holder.itemView, holder.getAdapterPosition());
                }
            }
        });
        holder.ivPreView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mOnItemChildClickListener.onItemChildClick(PlayerDownloadAdapter.this, v, holder.getAdapterPosition());
            }
        });
...
//        Log.i("scar", "onBindViewHolder: " + downloadMediaInfo.getProgress() + "__" + downloadMediaInfo.getStatus());

        if (downloadMediaInfo.getTvId() == null || downloadMediaInfo.getTvId().isEmpty()) {
            ...
            //当切换到电视剧界面，tvid不为空，下载到时候需要显示
            if (mIsShowChildVideo) {
                holder.tvSize.setText(Formatter.getFileSizeDescription(downloadMediaInfo.getSize()));
                //如果等于0，那么就是未观看
                if (downloadMediaInfo.getWatchNumber() == 0) {
                    holder.tvStatus.setText(mContext.getResources().getString(R.string.alivc_longvideo_no_watch));
                ...
                case 3:
                    ...
                    holder.tvTitle.setVisibility(View.INVISIBLE);
                    holder.tvSubTitle.setVisibility(View.VISIBLE);
                    holder.mTvDownload.setText(R.string.alivc_longvideo_cache_ing);
                ...
                case 6:
                    ...
                    holder.tvTitle.setVisibility(View.INVISIBLE);
                    holder.tvSubTitle.setVisibility(View.VISIBLE);
                    holder.mTvDownload.setText(R.string.alivc_longvideo_cache_fail);
                    holder.tvSize.setVisibility(View.GONE);
    ...
    public interface OnItemClickListener {
         ...
         * been clicked.
         */
        void onItemClick(PlayerDownloadAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(PlayerDownloadAdapter adapter, View view, int position);
    }
}
